<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="showappemp.aspx.cs" Inherits="showappemp" %>
    	...
    	<div class="section-top-border">
			...
			<asp:GridView ID="GridView1" runat="server" AllowPaging="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                ...
                <SortedDescendingHeaderStyle BackColor="#00547E" />
						...
						<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:job %>" SelectCommand="SELECT [empid], [jid], [jobtitle], [cid], [name], [qual], [specialization], [experiance] FROM [applyjobs] WHERE ([empid] = @empid)">
                            <SelectParameters>
